...
\sectionfont{%			            % Change font of \section command
 \huge  \usefont{T1}{qpl}{b}{sit}%		% bch-b-n: CharterBT-Bold font
...
\PersonalEntry{Birth of birth}{January 1, 1980}
\PersonalEntry{Physical Address}{111 First St, New York}
\PersonalEntry{Phone number}{(123) 000-0000}
\PersonalEntry{Mail address}{\url{me@home.com}}
