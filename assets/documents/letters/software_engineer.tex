...
\moderncvstyle{classic}                            % style options are 'casual' (default), 'classic', 'oldstyle' and 'banking'oldstyle
...
\usepackage[scale=0.75, top=6em, right=5em, bottom=1em, left=5em]{geometry}
